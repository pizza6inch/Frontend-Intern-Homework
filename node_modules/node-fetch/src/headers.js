...
/* c8 ignore next 9 */
// Validate header name using Node.js' validateHeaderName if available, or use a custom function
...
/* c8 ignore next 9 */
// Validate header value using Node.js' validateHeaderValue if available, or use a custom function
...
/**
 * Fetch API interface for HTTP request and response headers
 * @export
 * @class
