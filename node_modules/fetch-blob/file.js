...
const _File = class File extends Blob {
  ...
  constructor (fileBits, fileName, options = {}) {
    ...
    // If options is null, set options to an empty object
    if (options === null) options = {}

    // Simulate WebIDL type casting for NaN value in lastModified option
    const lastModified = options.lastModified === undefined ? Date.now() : Number(options.lastModified)
    if (!Number.isNaN(lastModified)) {
      // Set #lastModified to the provided lastModified value or the current timestamp
      this.#lastModified = lastModified
    }

    // Set #name to the provided fileName
  ...
  // Getter for lastModified property
  get lastModified () {
  ...
  // Static method for Symbol.hasInstance
