...
// Start the first test suite for checking the interface of 'hasSymbols' function
...
test('Symbols are supported', { skip: !hasSymbols() }, function (t) {
  // If Symbols are supported, run Symbol-related tests using 'runSymbolTests' function
  runSymbolTests(t);
...
test('Symbols are not supported', { skip: hasSymbols() }, function (t) {
  // If Symbols are not supported, check if 'Symbol' and 'Object.getOwnPropertySymbols' are undefined
